# Lab 13-05 — Advanced Integration

**Module:** 13 — Odoo ERP and business management  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-13-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect odoo to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 13-01 through 13-04 pass
